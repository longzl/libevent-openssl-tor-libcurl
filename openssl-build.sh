...
OPENSSL_COMPRESSED_FN="openssl-1.1.1t.tar.gz"
...
CROSS_TOP_LIST=(${IPHONE_OS_CROSS_TOP} ${IPHONE_OS_CROSS_TOP} ${IPHONE_SIMULATOR_CROSS_TOP})
# 各架构sdk名
...
CROSS_SDK_LIST=(${IPHONE_OS_CROSS_SDK} ${IPHONE_OS_CROSS_SDK} ${IPHONE_SIMULATOR_CROSS_SDK})
echo "ARCH_COUNT" $ARCH_COUNT  ${#CROSS_TOP_LIST[@]} ${#CROSS_TOP_LIST[@]}
# 编译配置
config_make()
{
# 接收第一个参数
